...
@pcc_set
class PanteaterPeterantLink(Link):
    USERAGENTSTRING = "PanteaterPeterant"
...
@subset(PanteaterPeterantLink)
class PanteaterPeterantUnprocessedLink(object):
    @staticmethod
    def __predicate__(l):
...
@impure
@subset(PanteaterPeterantUnprocessedLink)
class OnePanteaterPeterantUnProcessedLink(PanteaterPeterantLink):
    __limit__ = 1
    @staticmethod
    def __predicate__(l):
        return not (l.download_complete or l.error_reason)

@projection(PanteaterPeterantLink, PanteaterPeterantLink.url, PanteaterPeterantLink.download_complete)
class PanteaterPeterantProjectionLink(object):
    pass

@trigger(OnePanteaterPeterantUnProcessedLink, TriggerTime.after, TriggerAction.read)
...
@trigger(PanteaterPeterantLink, TriggerTime.after, TriggerAction.update)
